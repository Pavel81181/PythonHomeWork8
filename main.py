...
def bold_cyan(str):
    return "\033[1m\033[96m" + str +"\033[0m" 
...
def show_menu():
    print("\nВыберите необходимое действие:",
          bold_cyan("1") + ". Отобразить весь справочник",
          bold_cyan("2") + ". Найти абонента по фамилии",
          bold_cyan("3") + ". Найти абонента по номеру телефона",
          bold_cyan("4") + ". Добавить абонента в справочник",
          bold_cyan("5") + ". Удалить абонента по номеру телефона",
          bold_cyan("6") + ". Изменить абонента по номеру телефона",
          bold_cyan("7") + ". Сохранить справочник в текстовом формате",
          bold_cyan("8") + ". Закончить работу",
          sep="\n")
    choice = int(input())
    return choice
